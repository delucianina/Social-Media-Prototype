...
import { getUsers, getUser, createUser, updateUser, deleteUser, deleteFriend, getAllThoughts, getThoughtById, addThought, updateThought, deleteThought, addReaction, deleteReaction } from '../controllers/userController.js';
const router = Router();
// GET - ALL USERS BY ID
